...
const updateObj = {
    operations: [
        {
            type: 'updateNode',
            nodeName: 'Montar Prompt IA',
            updates: {
                parameters: jsNode.parameters
            }
        }
    ]
};

fs.writeFileSync('C:/Users/40000398/OneDrive - ArcelorMittal/Desktop/n8n/update_n8n.json', JSON.stringify(updateObj.operations, null, 2));

console.log('Update JSON created.');
